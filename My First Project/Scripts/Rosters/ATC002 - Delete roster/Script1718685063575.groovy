...
WebUI.click(findTestObject('Object Repository/Page_Wageloch - Rosters/span_VIEW'))

WebUI.click(findTestObject('Object Repository/Page_Wageloch - Edit Roster/button_OK'))

WebUI.click(findTestObject('Object Repository/Page_Wageloch - Edit Roster/span_DELETE ROSTER'))
